    ...
    var body: some View {
        Form {
            Section(header: Text(NSLocalizedString(
                "settings_sectionCalendarSettings",
                comment: "Section: Calendar Settings"
            ))) {
                NavigationLink(
            ...
            Section(header: Text(NSLocalizedString(
                "settings_sectionCustomization",
                comment: "Section: Customization"
            ))) {
                Picker(
                    selection: customizationData.$savedFontSize,
                    label: Text(NSLocalizedString("settings_fontSize", comment: "Font Size")),
                    content: {
                ...
                Picker(
                    selection: customizationData.$savedFontStyle,
                    label: Text(NSLocalizedString("settings_fontStyle", comment: "Font Style")),
                    content: {
